...
Q_pos = np.array([5.800255505, 5.023168615, 25.621479712804486]) 
Q0 = 0   # Initial charge, when restarting change this to charge of second last ionic step
rQ_list = [Q_pos]
Q_list = [Q0]  

nelect_neutral =  1184 # NELECT of neutral system
grid_roll_frac = 0.2
grid_position_frac =0.84  # dipole correction position
width_wall = 6.5 # Confining wall width in Angstrom
pos_right_wall = 27.621479712804486 # Position of confining wall
ax, ay, az = (11.60051101, 10.04633723, 36.37147971) 



z_gold_surf = 7.103833182162994 
d_electrode = Q_pos[2] - z_gold_surf
